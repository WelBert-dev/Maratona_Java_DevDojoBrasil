...
public class Arrays {
    public static void main(String[] args) {
        ...
        System.out.println(vContatoGenerics);
        vContatoGenerics.add(new Contato("Pamonha", "(11) 9 9999-9999", "pamonha@hotmail.com"), 1);
        System.out.println(vContatoGenerics);
        vContatoGenerics.removeElementByElement(new Contato("Pamonha", "(11) 9 9999-9999", "pamonha@hotmail.com"));
        System.out.println(vContatoGenerics);
        System.out.println(vContatoGenerics.getIndexOfElement(new Contato("Wellison", "(11) 9 4298-9935", "wellison.bertelli@hotmail.com")));
    }
}
...
class VetorGenericoComGenerics<T> {
    private T[] elements;
    private int size;
